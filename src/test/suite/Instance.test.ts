...
suite("CodeNow Integration", async function ()
{
    ...
    {
        instance = await commands.executeCommand<Instance>("cn.connect", { instanceName: process.env.npm_config_instance, userName: process.env.npm_config_user, password: process.env.npm_config_secret });
        if (instance)
        {
